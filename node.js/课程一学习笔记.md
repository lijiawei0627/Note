...
* 数据如何存储
  ...
  * 博客
    ...
    ![image-20200320152559092](D:\Note\image\image-20200320152559092.png)

  * 用户

    ![image-20200320152608576](D:\Note\image\image-20200320152608576.png)

* 如何与前端对接，即接口设计

  ![image-20200320152736020](D:\Note\image\image-20200320152736020.png)
...
* `MongoDB`：数据库、集合、文档
  ...
  * 数据库和集合
    ...
    ![image-20200321151352643](D:\Note\image\image-20200321151352643.png)

  * 文档

    ![image-20200321151358241](D:\Note\image\image-20200321151358241.png)

## 新建库

## 新建表结构

![image-20200321145129278](D:\Note\image\image-20200321145129278.png)
...
![image-20200321145621962](D:\Note\image\image-20200321145621962.png)

![image-20200321145613066](D:\Note\image\image-20200321145613066.png)
...
![image-20200322165001739](D:\Note\image\image-20200322165001739.png)
...
* 反向代理
  ...
  ![image-20200323134342541](D:\Note\image\image-20200323134342541.png)
...
![image-20200323145633468](D:\Note\image\image-20200323145633468.png)
...
![image-20200323171847818](D:\Note\image\image-20200323171847818.png)
...
![image-20200323172638664](D:\Note\image\image-20200323172638664.png)

**通过流的方式拷贝文件**

![image-20200324102831418](D:\Note\image\image-20200324102831418.png)

**通过网络请求读取文件内容，响应给用户**

![image-20200324102925079](D:\Note\image\image-20200324102925079.png)
...
![image-20200324160736818](D:\Note\image\image-20200324160736818.png)
...
![image-20200329125412091](D:\Note\image\image-20200329125412091.png)
...
* 基本使用
  ...
  ![image-20200329140949389](D:\Note\image\image-20200329140949389.png)
...
* 常用命令
  ...
  * `pm2 info <AppName>/<id>` 查看进程的基本信息
    ...
    * `out log path：`自定义日志
    ...
    ![image-20200329141421085](D:\Note\image\image-20200329141421085.png)
...
* 为何使用多进程
  ...
  * `CPU`：无法充分利用多核`CPU`的优势
  ...
  ![image-20200329151617397](D:\Note\image\image-20200329151617397.png)
...
![image-20200329151545565](D:\Note\image\image-20200329151545565.png)

`npm run prd`

![image-20200329152131535](D:\Note\image\image-20200329152131535.png)
